...
def pruning_for_data(data):
    ...
    # print(data["inputs_embeds"].shape)
    # print(data["hidden_states"].shape)
    # print(data["hidden_states_mid"].shape)
    # print(data["target"].shape)
    # print(data["attention_mask"].shape)
    # print(data["loss_mask"].shape)
    ...
    # print(new_data["inputs_embeds"].shape)
    # print(new_data["hidden_states"].shape)
    # print(new_data["hidden_states_mid"].shape)
    # print(new_data["target"].shape)
    # print(new_data["attention_mask"].shape)
    # print(new_data["loss_mask"].shape)
...
# checkpoint_dir = "//vast/zl5961/llava_vicuna_7B_rl_input/state_0"
