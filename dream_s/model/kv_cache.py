...
def initialize_past_key_values(model, use_quantized_kv=False, quantization_bits=8):
    """
    ...
    if use_quantized_kv:
        manager = QuantizedKVCacheManager(model, quantization_bits)
        return manager.initialize_quantized_past_key_values()
