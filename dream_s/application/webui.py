...
from dream_s.model.modeling_llava_next import LlavaNextForConditionalGeneration
...
with gr.Blocks(css=custom_css) as demo:
    ...
    with gr.Row():
        with gr.Column():
            use_EaInfer = gr.Checkbox(label="Use DREAM-S", value=True)
            highlight_EaInfer = gr.Checkbox(label="Highlight the tokens generated by DREAM-S", value=True)
    ...
    note=gr.Markdown(show_label=False,interactive=False,value='''The Compression Ratio is defined as the number of generated tokens divided by the number of forward passes in the original LLM. If "Highlight the tokens generated by DREAM-S" is checked, the tokens correctly guessed by DREAM-S 
    ...
    with gr.Row():
        ...
        user_image = gr.Image(label="Ppload image", type="filepath")
